...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "channels.bundle.js";
...
var _appReducer = __webpack_require__(350);
...
var Store = (0, _store2.default)(_appReducer2.default);
...
var _CACHE_SERVICE = __webpack_require__(348);

var _CACHE_SERVICE2 = _interopRequireDefault(_CACHE_SERVICE);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function cacheDecorator(storeName) {
    return function (target) {
        target.setCacheData = function (storeData) {
            _CACHE_SERVICE2.default.setItem(storeName, storeData);
        };

        target.getCachedData = function (storeName, storeKey) {
            var cachedData = _CACHE_SERVICE2.default.getItem(storeName);
            ...
            try {
                for (var _iterator = cachedData[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var EVENT_MANAGER = function () {
    function EVENT_MANAGER() {
        _classCallCheck(this, EVENT_MANAGER);
    ...
    _createClass(EVENT_MANAGER, [{
        ...
        value: function subscribe(_ref2) {
            ...
            var listenerExist = !!listeners[type].filter(function (listener) {
...
exports.default = new EVENT_MANAGER();
...
var _cacheDecorator = __webpack_require__(128);

var _cacheDecorator2 = _interopRequireDefault(_cacheDecorator);
...
var ARTICLES_SERVICE = (_dec = (0, _cacheDecorator2.default)('articlesList'), _dec(_class = function () {
    ...
    _createClass(ARTICLES_SERVICE, null, [{
        ...
        value: function getArticles(channelKey) {
            var cachedArticles = this.getCachedData('articlesList', channelKey);
            ...
            return ARTICLES_SERVICE.retrieveArticles(channelKey).then(function (response) {
                if (response.ok) {
                    return response.json().then(function (articlesList) {
                        var storeData = { channelKey: channelKey, articles: articlesList.articles };
        ...
        value: function retrieveArticles(channelKey) {
...
var CHANNELS_SERVICE = (_dec = (0, _cacheDecorator2.default)('channelsList'), _dec(_class = function () {
    ...
    _createClass(CHANNELS_SERVICE, null, [{
        ...
        value: function getChannels() {
            var storageData = this.getCachedData('channelsList');
            ...
            return CHANNELS_SERVICE.retrieveChannels().then(function (response) {
                if (response.ok) {
                    return response.json().then(function (channelsList) {
        ...
        key: 'retrieveChannels',
        value: function retrieveChannels() {
...
var _articlesList = __webpack_require__(347);

var _articlesList2 = _interopRequireDefault(_articlesList);

var _publishSubscribe = __webpack_require__(129);

var _publishSubscribe2 = _interopRequireDefault(_publishSubscribe);

var _subscribe = __webpack_require__(354);

var _subscribe2 = _interopRequireDefault(_subscribe);

var _navigationControls = __webpack_require__(355);

var _navigationControls2 = _interopRequireDefault(_navigationControls);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var getChannelsAssetsButton = document.querySelector('.getNewsListAssetsButton');

var lazyImportChannelsAssets = function lazyImportChannelsAssets() {
    return new Promise(function (resolve) {
        __webpack_require__.e/* require.ensure */(0).then((function (require) {
            resolve(__webpack_require__( /* webpackChunkName : "channels-list" */
            /* webpackMode: "lazy" */
            358));
...
var getChannelsAssetsHandler = function getChannelsAssetsHandler() {
    this.classList.add('btn--hidden');

    lazyImportChannelsAssets().then(function (Channel) {
...
document.addEventListener('scroll', function () {
    return _publishSubscribe2.default.publish({ type: 'documentScroll' });
});

new _articlesList2.default({
    initElement: document.querySelector('articles-list'),
    step: 5
});

new _navigationControls2.default({
    initElement: document.querySelector('navigation-controls')
});

new _subscribe2.default({
    strategy: new _subscribe.WeeklySubscribe(),
...
// module
exports.push([module.i, "body {\n  margin: 0;\n  padding: 0;\n  min-height: 100%;\n  position: relative;\n  font-family: 'Roboto-Regular', 'Arial', sans-serif; }\n\n@font-face {\n  font-family: 'Roboto-Light';\n  web-app: url(" + __webpack_require__(338) + ") format(\"woff\"), url(" + __webpack_require__(339) + ") format(\"truetype\");\n  font-style: normal;\n  font-weight: normal; }\n\n@font-face {\n  font-family: 'Roboto-Regular';\n  web-app: url(" + __webpack_require__(340) + ") format(\"woff\"), url(" + __webpack_require__(341) + ") format(\"truetype\");\n  font-style: normal;\n  font-weight: normal; }\n\n@font-face {\n  font-family: 'Roboto-Medium';\n  web-app: url(" + __webpack_require__(342) + ") format(\"woff\"), url(" + __webpack_require__(343) + ") format(\"truetype\");\n  font-style: normal;\n  font-weight: normal; }\n\n.app {\n  margin: 0 auto;\n  display: flex;\n  min-height: 100vh;\n  padding: 0 16px;\n  box-sizing: border-box;\n  flex-direction: column; }\n\n@media (min-width: 960px) {\n  .app {\n    width: 920px; } }\n\nheader {\n  flex-shrink: 0; }\n\nheader h1 {\n  font-family: 'Roboto-Light', 'Arial', sans-serif;\n  position: relative;\n  font-weight: 400;\n  text-align: center;\n  margin-top: 50px;\n  color: #000; }\n  header h1:after {\n    content: '';\n    display: block;\n    width: 100px;\n    border-top: 1px solid #a9a9a9;\n    left: 50%;\n    transform: translateX(-50%);\n    position: absolute;\n    bottom: -20px; }\n\nmain {\n  margin: 75px 0 50px;\n  flex: 1 0 auto; }\n\n.getNewsListAssetsButton {\n  transform: translate(-50%, -50%);\n  top: 50%;\n  left: 50%;\n  position: absolute; }\n\n.btn {\n  font-family: 'Roboto-Medium', 'Arial', sans-serif;\n  cursor: pointer;\n  display: inherit;\n  background: none;\n  border-radius: 3px;\n  padding: 10px 30px;\n  color: rgba(255, 68, 34, 0.6);\n  border: 2px solid rgba(255, 68, 34, 0.6); }\n  .btn:hover {\n    background-color: rgba(255, 68, 34, 0.9);\n    color: #fff;\n    border-color: rgba(255, 68, 34, 0.6); }\n\n.btn-block .btn {\n  display: inline-block;\n  padding: 5px 10px;\n  margin: 0 5px; }\n\n.btn--hidden {\n  display: none; }\n\nfooter {\n  border-top: 1px solid #cecece;\n  padding: 20px 0;\n  font-family: 'Roboto-Light', 'Arial', sans-serif;\n  font-size: 12px;\n  text-align: right;\n  flex-shrink: 0; }\n\nfooter a {\n  text-decoration: none;\n  color: #f42; }\n\narticles-list {\n  display: block; }\n", ""]);
...
module.exports = "./Roboto-Light.woff";

/***/ }),
/* 339 */
/***/ (function(module, exports) {

module.exports = "./Roboto-Light.ttf";

/***/ }),
/* 340 */
/***/ (function(module, exports) {

module.exports = "./Roboto-Regular.woff";
...
module.exports = "./Roboto-Medium.woff";

/***/ }),
/* 343 */
/***/ (function(module, exports) {

module.exports = "./Roboto-Medium.ttf";
...
var _controls = __webpack_require__(349);
...
var initShowMoreButton = function initShowMoreButton() {
...
var showMoreHandler = function showMoreHandler() {
    this.articlesListElement.innerHTML = this.articlesListElement.innerHTML + this._retrieveArticles();

    var addedArticlesList = Array.prototype.slice.call(this.articlesListElement.querySelectorAll('.articlesList-item'), -this._step);
    addedArticlesList = addedArticlesList.filter(function (article) {
        return article.querySelector('.controlsHolder').innerText === '';
    });
    ...
    _createClass(Articles, [{
        ...
        value: function _storeSubscribe() {
            ...
            _appStore2.default.subscribe(function () {
                _this.articlesList = _appStore2.default.getState().selectedChannelArticles;

                if (!_this.articlesList) {
                    return;
                }
        ...
        key: '_attachControls',
        value: function _attachControls(articlesList) {
            for (var i = 0; i < articlesList.length; i++) {
                var controlsHolder = articlesList[i].querySelector('.controlsHolder');
                controlsHolder.appendChild(_controls2.default.createControl('comment').button);
                controlsHolder.appendChild(_controls2.default.createControl('print').button);
            }
        }
    }, {
        key: '_attachHandlers',
        ...
        key: '_retrieveArticles',
        value: function _retrieveArticles() {
...
var Cache = function () {
    ...
    _createClass(Cache, [{
        ...
        key: 'setItem',
        value: function setItem(itemName, data) {
            var cache = this.getItem(itemName);
            var outputData = [];
...
var Control = function () {
    ...
    _createClass(Control, [{
        ...
        key: 'createControl',
        value: function createControl(name) {
            if (name === 'comment') {
...
var commentControl = function (_Control) {
    _inherits(commentControl, _Control);

    function commentControl(_ref) {
        var _ref$controlText = _ref.controlText,
            controlText = _ref$controlText === undefined ? 'Add a comment' : _ref$controlText;

        _classCallCheck(this, commentControl);

        var _this = _possibleConstructorReturn(this, (commentControl.__proto__ || Object.getPrototypeOf(commentControl)).call(this));

        _this.controlText = controlText;
        _this.render();
        return _this;
    }
...
var printControl = function (_Control2) {
    _inherits(printControl, _Control2);

    function printControl(_ref2) {
        var _ref2$controlText = _ref2.controlText,
            controlText = _ref2$controlText === undefined ? 'Print' : _ref2$controlText;

        _classCallCheck(this, printControl);

        var _this2 = _possibleConstructorReturn(this, (printControl.__proto__ || Object.getPrototypeOf(printControl)).call(this));

        _this2.controlText = controlText;
        _this2.render();
        return _this2;
    }
...
function NewsApp() {
    ...
    switch (action.type) {
        case _actionTypes2.default.CHANNELS_LIST_INIT:
            return Object.assign({}, state, {
                channels: action.channels
            });
        case _actionTypes2.default.ARTICLES_LIST_INIT:
            return Object.assign({}, state, {
                selectedChannelArticles: action.articles
            });
        case _actionTypes2.default.NAVIGATION_VISIBILITY:
            return Object.assign({}, state, {
...
// module
exports.push([module.i, ".articlesList {\n  list-style-type: none;\n  padding: 0;\n  margin: 0; }\n\n.articlesList-item {\n  margin-bottom: 50px;\n  text-align: center; }\n\n.articleDescription {\n  text-align: justify;\n  margin-top: 25px; }\n\n.articleImage {\n  width: 100%; }\n\n.articleTitle {\n  margin-top: 0;\n  font-size: 40px;\n  margin-bottom: 15px;\n  text-align: left;\n  color: #F42; }\n\n.articleAuthor {\n  color: #F42; }\n\n.articleDate {\n  text-align: left;\n  padding-bottom: 25px;\n  margin-bottom: 35px;\n  border-bottom: 1px solid #ddd; }\n\n.articlesList-showMoreButton {\n  margin: 0 auto; }\n\n.articlesList-showMoreButton--hidden {\n  display: none; }\n\n.controlsHolder {\n  text-align: right; }\n", ""]);
...
var Subscribe = function () {
    ...
    _createClass(Subscribe, [{
        ...
        key: '_createElementHTML',
        value: function _createElementHTML() {
...
var MonthlySubscribe = function MonthlySubscribe() {
    _classCallCheck(this, MonthlySubscribe);

    this.subscription = 2;
    this.subscriptionText = 'every month';
};

var WeeklySubscribe = function WeeklySubscribe() {
    _classCallCheck(this, WeeklySubscribe);

    this.subscription = 1;
    this.subscriptionText = 'every week';
};

var DailySubscribe = function DailySubscribe() {
    _classCallCheck(this, DailySubscribe);

    this.subscription = 0;
    this.subscriptionText = 'every day';
};

exports.DailySubscribe = DailySubscribe;
exports.WeeklySubscribe = WeeklySubscribe;
exports.MonthlySubscribe = MonthlySubscribe;
...
var backButtonHandler = function backButtonHandler() {
    _appStore2.default.dispatch({ type: _actionTypes2.default.CHANNELS_LIST_INIT, channels: _CHANNELS_SERVICE2.default.getChannels() });
    _appStore2.default.dispatch({ type: _actionTypes2.default.NAVIGATION_VISIBILITY, isNavigationVisible: false });
    _appStore2.default.dispatch({ type: _actionTypes2.default.ARTICLES_LIST_INIT, articles: [] });
    this.element.classList.add('navigationControls--hidden');
};

var documentScrollHandler = function documentScrollHandler() {
    window.pageYOffset > 500 ? this.scrollUpButton.classList.remove('navigationControls-button--hidden') : this.scrollUpButton.classList.add('navigationControls-button--hidden');
};

var scrollUpButtonHandler = function scrollUpButtonHandler() {
    _publishSubscribe2.default.unsubscribe({ type: 'documentScroll', handler: documentScrollHandler });
    window.scrollTo(0, 0);
};
...
var Navigation = function () {
    ...
    _createClass(Navigation, [{
        ...
        value: function _storeSubscribe() {
            ...
            _appStore2.default.subscribe(function () {
                _this.isNavigationVisible = _appStore2.default.getState().isNavigationVisible;
                _this.render();
            });
        }
    }, {
        ...
        value: function _attachHandlers() {
            ...
            _publishSubscribe2.default.subscribe({ type: 'documentScroll', handler: documentScrollHandler.bind(this) });
        }
    }, {
        key: 'render',
        value: function render() {
...
// module
exports.push([module.i, ".navigationControls {\n  width: 100%;\n  position: fixed;\n  left: 0; }\n\n.navigationControls--hidden {\n  display: none; }\n\n.navigationControls-inner {\n  width: 960px;\n  position: relative;\n  height: 65px;\n  margin: 0 auto; }\n\n.navigationControls-button {\n  position: absolute;\n  background: none;\n  color: rgba(255, 68, 34, 0.6);\n  border: none;\n  cursor: pointer;\n  font-family: 'Roboto-Medium', 'Arial', sans-serif;\n  font-size: 15px;\n  top: 15px; }\n  .navigationControls-button:hover {\n    color: #ff4422; }\n  .navigationControls-button svg {\n    fill: currentColor;\n    vertical-align: middle; }\n\n.navigationControls-button--hidden {\n  display: none; }\n\n#backHomeButton {\n  left: -75px; }\n  #backHomeButton svg {\n    margin-right: 5px; }\n\n#scrollUpButton {\n  right: -90px; }\n  #scrollUpButton svg {\n    margin-left: 5px; }\n\n@media (min-width: 1160px) {\n  .navigationControls {\n    bottom: 50px; } }\n\n@media (max-width: 1160px) {\n  .navigationControls {\n    background-color: #fff;\n    bottom: 0;\n    top: auto; }\n  #backHomeButton {\n    left: 25px;\n    top: 15px; }\n  #scrollUpButton {\n    right: 25px;\n    top: 15px; } }\n\n@media (max-width: 960px) {\n  .navigationControls-inner {\n    width: 100%; }\n  #backHomeButton {\n    left: 10px; }\n  #scrollUpButton {\n    right: 10px; } }\n", ""]);
